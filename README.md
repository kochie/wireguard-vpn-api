...
This is a sample template for wireguard-vpn-api - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name wireguard-vpn-api --query 'Stacks[].Outputs'
```
